...
// Config
var specTimeoutMs = yanatra.env.args.timeout || yanatra.env.config.timeout || 5000; // 30 seconds
...
var El1 = element(by.model('')).constructor;
var El2 = element(by.name('')).constructor;
var El3 = element(by.binding('')).constructor;


El1.prototype.waitReady =
El2.prototype.waitReady =
El3.prototype.waitReady =
